...
#define INTL_STATIC_IP_TEXT "INTL_STATIC_IP_TEXT"
const char INTL_STATIC_IP[] PROGMEM = "INTL_STATIC_IP";
const char INTL_STATIC_SUBNET[] PROGMEM = "INTL_STATIC_SUBNE";
const char INTL_STATIC_GATEWAY[] PROGMEM = "INTL_STATIC_GATEWAY";
const char INTL_STATIC_DNS[] PROGMEM = "INTL_STATIC_DNS";

// MQTT 
const char INTL_SEND_TO_MQTT[] PROGMEM = "INTL_SEND_TO_MQTT";
