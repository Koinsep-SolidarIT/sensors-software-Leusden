...
// MQTT
const char INTL_SEND_TO_MQTT[] PROGMEM = "Verzend data naar MQTT";
...
const char INTL_SCD30_CO2_CORRECTION[] PROGMEM = "Correctie in CO₂";
...
const char INTL_TIME_UTC[] PROGMEM = "Tijd ";
